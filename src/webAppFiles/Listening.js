...
const Listening = () => {
  return (
    <Container>
      ...
      <MessageNote>
        Note 2: Generally Learning Arabic requires a significant amount of time,
        as it involves listening to the lecture, taking notes, memorizing
        vocabs, doing exercises and so on. So if a student has time to do these
        things he can embark to learn Arabic, else if he may start to learn once
        when gets such a situation.
      </MessageNote>
      <Card sx={{ marginBottom: "2rem", mt: "1.3rem" }}>
        <CardContent>
          <Typography variant="h6" gutterBottom>
            Weekend Classes :
          </Typography>
