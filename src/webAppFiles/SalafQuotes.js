...
const tadeem = [
  {
    text: "Abū 'Abdullāh, Aḥmad ibn Ḥanbal During his childhood, might well have wanted to leave before Fajr to go to the circles of the scholars, but his mother would hold on to his clothing, as a mercy to him, until the adhaan would be given, or the morning would come.",
    reference: "ta'dheemul ilm, third principle.",
    narrator: "It has been narrated that",
  },
  {
    text: "Abū Muḥammad Ibn at-Tabbān In the very beginning, would study the whole night, but his mother was merciful to him, and she stopped him from reading at night. He used to take the lamp and put it under the jafanah (a kind of large vessel), and he would pretend to be asleep. When his mother would fall asleep, he would take out the lamp and start to study.",
    reference: "ta'dheemul ilm, third principle.",
    narrator: "It has been narrated that ",
  },
  {
  ...
  },
  {
    ...
    reference: "ta'dheemul ilm, eighth principle.",
    narrator: "Ḥammād ibn Abī Sulaymān said to a student of his,",
  },
  {
